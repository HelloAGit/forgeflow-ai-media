...
async def create_generation(req: GenerationRequest):
    try:
        ...
        logger.exception("Failed to create generation for prompt: %s", req.prompt)
        raise HTTPException(status_code=500, detail="Media generation failed. Please try again later.")
